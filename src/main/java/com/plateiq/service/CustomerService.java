...
public class CustomerService {
    ...
    public Vehicle getVehicleFullDetails(String registrationNumber) {
        String sql =
            "SELECT vfd.vehicle_id, vfd.registration_number, vfd.make, vfd.model, " +
        ...
        try (
            ...
            LOGGER.log(
                Level.SEVERE,
                "Failed to get full vehicle details: " + registrationNumber,
                e
            );
        }
    ...
    public boolean submitQuery(
        ...
        String sql =
            "INSERT INTO customerquery (customer_id, vehicle_id, query_date, query_text) " +
            "VALUES (?, ?, ?, ?)";
        ...
        try (
            ...
            LOGGER.log(
                Level.SEVERE,
                "Failed to submit query from customer: " + customerId,
                e
            );
            return false;
        }
    ...
    public List<CustomerQuery> getQueriesByCustomer(int customerId) {
        String sql =
            "SELECT cq.*, v.registration_number AS vehicle_registration, " +
        ...
        try (
            ...
            LOGGER.log(
                Level.SEVERE,
                "Failed to get queries for customer: " + customerId,
                e
            );
        }
    ...
    public CustomerQuery getQueryById(int queryId) {
        ...
        try (
            ...
            LOGGER.log(
                Level.SEVERE,
                "Failed to get query by ID: " + queryId,
                e
            );
        }
    ...
    public boolean respondToQuery(int queryId, String responseText) {
        String sql =
            "UPDATE customerquery SET response_text = ? WHERE query_id = ?";
        ...
        try (
            ...
            LOGGER.log(
                Level.SEVERE,
                "Failed to respond to query: " + queryId,
                e
            );
            return false;
        }
    ...
    private CustomerQuery buildQueryFromResultSet(ResultSet rs)
        throws SQLException {
        ...
        LocalDate queryDate =
            queryDateSql != null ? queryDateSql.toLocalDate() : null;
